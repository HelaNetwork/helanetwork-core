...
const (
	...
	CfgRegistryDisableEntityRegistration        = "registry.disable_entity_registration"
...
func AppendRegistryState(doc *genesis.Document, entities, runtimes, nodes []string, l *logging.Logger) error {
	regSt := registry.Genesis{
		Parameters: registry.ConsensusParameters{
			...
			DisableEntityRegistration:     viper.GetBool(CfgRegistryDisableEntityRegistration),
...
func init() {
	...
	initGenesisFlags.Bool(CfgRegistryDisableEntityRegistration, false, "disable non-genesis entity registration")
